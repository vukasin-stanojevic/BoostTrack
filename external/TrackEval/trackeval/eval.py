...
def eval_sequence(seq, dataset, tracker, class_list, metrics_list, metric_names):
    ...
    seq_res = {}
    # print("SEQ: ", seq)  # for example: MOT17-02-FRCNN
    # print(dataset)  # <trackeval.datasets.mot_challenge_2d_box.MotChallenge2DBox object at 0x7f357db0bc10>
    # print(tracker)  # exp_name, for example: exp12345_post
    # print(class_list)  # ['pedestrian']
    # print(metrics_list)  # [<trackeval.metrics.hota.HOTA object at 0x7f357db0bd00>,
    # <trackeval.metrics.identity.Identity object at 0x7f357db0bdc0>,
    # <trackeval.metrics.count.Count object at 0x7f357db0bdf0>]
    # print(metric_names)  # ['HOTA', 'Identity', 'Count']
    # exit(0)
    for cls in class_list:  # ['pedestrian']
        seq_res[cls] = {}
